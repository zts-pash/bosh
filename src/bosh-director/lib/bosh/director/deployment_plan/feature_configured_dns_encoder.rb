    ...
    class FeatureConfiguredDNSEncoder
      ...
      def encode(
        ...
        @dns_encoder.encode_query(
          ...
          group_name:      group_name(link_group_name, instance_group_name),
          root_domain:     @root_domain,
      ...
      #   @dns_encoder.encode_query(
      #     group_type:      instance_group_type,
      ...
      def group_type
        return Models::LocalDnsEncodedGroup::Types::LINK if @use_link_address

        instance_group_type
      end

      def instance_group_type
        Models::LocalDnsEncodedGroup::Types::INSTANCE_GROUP
      end

      def group_name(link_group_name, instance_group_name)
        return link_group_name if @use_link_address
