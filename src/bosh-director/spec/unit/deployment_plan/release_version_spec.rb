...
describe Bosh::Director::DeploymentPlan::ReleaseVersion do
  ...
  describe 'looking up/adding templates' do
    ...
    it 'finds template/package models by name' do
      ...
      release.bind_model
      expect(release.get_job_model_by_name('dea')).to eq(t1)
      expect(release.get_job_model_by_name('stager')).to eq(nil)
      ...
      release.bind_model
      expect(release.get_job_model_by_name('dea')).to eq(nil)
      expect(release.get_job_model_by_name('stager')).to eq(t2)
